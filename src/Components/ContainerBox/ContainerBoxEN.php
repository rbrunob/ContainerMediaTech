<section id="containerBox">
    <div class="containerbox_row">
        <div class="containerbox_image">
            <img src="https://preprod.containermedia.com.br/containermediatech/src/assets/images/logos-canais-3d.webp" alt="Logo Container e canais Box" loading="lazy" class="out-in left" />
        </div>
